export type EstadoDesgaste = 'normal' | 'advertencia' | 'critico' | 'sin-datos';

export type EstadoBateria = 'normal' | 'advertencia' | 'critico' | 'sin-datos';
...
export interface CarbonResponse {
  ...
  // nivel_temperatura_aviso: number;
  // nivel_temperatura_minimo: number;
}
